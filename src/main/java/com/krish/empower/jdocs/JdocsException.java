...
public class JdocsException extends RuntimeException {

  private static Logger logger = LogManager.getLogger(JdocsException.class);
  ...
  public JdocsException(String code, String... vargs) {
  ...
  public JdocsException(ErrorTuple et) {
    this.et = et;
  ...
  public JdocsException(String code, Throwable cause, String... vargs) {
    super(cause);
    this.et.setErrorCode(code);
