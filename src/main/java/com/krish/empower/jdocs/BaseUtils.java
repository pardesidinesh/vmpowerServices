...
public class BaseUtils {
  ...
  public static void sleep(long millis) {
    try {
      ...
      throw new JdocsException("base_err_4", ex);
    }
  }
  ...
  public static ZonedDateTime getZonedDateTimeFromString(String dt, String pattern, Locale locale) {
    try {
      ...
      throw new JdocsException("base_err_1", e);
    }
  }
  ...
  public static String getResourceAsString(Class clazz, String filePath) {
    ...
    try {
      ...
      throw new JdocsException("base_err_3", ex);
    }
    return s;
  }
   ...
   */
  public static String getStringFromStream(InputStream inputStream) throws JdocsException {
   ...
   * @return The error String
   */
  public static String getErrorString(JdocsException e) {
