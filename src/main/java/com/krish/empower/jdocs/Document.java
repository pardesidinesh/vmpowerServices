...
public interface Document {
   ...
   * @throws JdocsException If the document is a typed document and the path is not found in the associated model document
   ...
   * @throws com.JdocsException.unify.jdocs.UnifyException If the document is a typed document and the path is not found in the associated model document
   *                                                        If the document is a typed document and the type of the path in the model document does not match
   *                                                        If the type of the value specified in the path in the document does not match
   *                                                        If the path specified does not point to a leaf node
   */
   ...
   * @param vargs               the values to replace the % characters in path
   * @throws JdocsException If the path specified does not point to a complex object
   ...
   * @throws JdocsException If the from document is a typed document and the path is not found in the associated model document
