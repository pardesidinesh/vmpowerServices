...
public class DocumentTest {
  ...
  void testRead() {
    ...
    JdocsException e = assertThrows(JdocsException.class, () -> {
      d.getString("$.id1");
    });
    assertEquals("jdoc_err_38", e.getErrorCode());

    e = assertThrows(JdocsException.class, () -> {
  ...
  void testCopy() {
    ...
    catch (JdocsException e) {
      assertEquals(JdocsException.class, e.getClass());
